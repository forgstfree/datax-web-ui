...
<html>
  <head>
    ...
    <meta
      name="description"
      content="Interactive diagram implemented by GoJS using Vue.js, including a diagram component and model binding."
    />
  ...
  <body onload="init()">
    <div id="sample">
      ...
      <p>
        That component also supports two different ways of modifying the
        diagram: access to the <a>Model</a> via the "model" method so that code
        can call Model methods such as <a>Model.setDataProperty</a>, and an
